...
/*
        ...
        if ($size == 'all') {
            ...
            foreach ($sizes as $size) {
                $output = '<img src="http://www.fontsquirrel.com/utils/makeFont.php?font=' . $metadata['id'] . '/' . $metadata['font_filename'] . '&width=700&size=' . $size . '&text=' . urlencode($text) . '" />';
            }
...
echo $fs->fs_preview($font,'Abcd 1234','12')
